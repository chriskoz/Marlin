...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,2560,513.747}  // default steps per unit for ultimaker 
...
#define ABS_PREHEAT_FAN_SPEED 190		// Insert Value between 0 and 255
